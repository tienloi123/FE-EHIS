...
const DoctorManagement = () => {
    ...
    const fetchPayments = useCallback(async (page, pageSize) => {
        ...
        try {
            ...
            const response = await axiosClient.get("/doctor", { params });
                        ...
                        <Table>
                            <TableHead>
                                <TableRow>
                                    ...
                                    <TableCell><b>Chuyên ngành</b></TableCell>
                                    <TableCell><b>Phòng khám</b></TableCell>
                            ...
                            <TableBody>
                                {patientList.map((patient) => (
                                    <TableRow key={patient.id}>
                                        ...
                                        <TableCell>
                                            {patient.role === 'Doctor' ? 'Bác sĩ' : patient.role}
                                        </TableCell>
                                        <TableCell>{patient.department}</TableCell>
                                        <TableCell>{patient.clinic_location}</TableCell>
